...
export default function App() {
  ...
  // calcula intervalo conforme seleção rápida
  ...
  return (
    <div style={{ padding: 20, fontFamily: "Arial, sans-serif" }}>
      ...
      <div style={{
        ...
        <button onClick={() => aplicarPeriodo("24h")}
          style={{ background: periodo === "24h" ? "#2196f3" : "#eee", padding: "4px 10px", borderRadius: 4 }}>
          Últimas 24h
        </button>

        <button onClick={() => aplicarPeriodo("semana")}
          style={{ background: periodo === "semana" ? "#2196f3" : "#eee", padding: "4px 10px", borderRadius: 4 }}>
          Última semana
        </button>

        <button onClick={() => aplicarPeriodo("mes")}
          style={{ background: periodo === "mes" ? "#2196f3" : "#eee", padding: "4px 10px", borderRadius: 4 }}>
          Último mês
        </button>
      </div>
      ...
      {/* Gráficos */}
      {dados.length === 0 ? (
        <p>⚠️ Falha ao carregar dados. Verifique a API.</p>
      ) : (
        <>
          ...
          <div style={{ marginTop: 30 }}>
            ...
            />
            <h4 style={{ marginTop: 10 }}>🌧️ Total no período: <b>{totalChuva.toFixed(2)} mm</b></h4>
          </div>
        </>
      )}
    </div>
